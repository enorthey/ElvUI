...
-- /rb sum physical fap
L["Sum Feral Attack Power"] = "Cumul Puissance d'attaque (Féral)"
...
L["statList"] = {
	...
	{pattern = "résilience", id = COMBAT_RATING_RESILIENCE_PLAYER_DAMAGE_TAKEN}, -- resilience is implicitly a rating
	...
	{pattern = "score de maîtrise", id = CR_MASTERY},
