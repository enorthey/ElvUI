...
-- /rb stat int mp5
--L["Show Combat Mana Regen"] = "显示施法回魔"
--L["Show Mana Regen while in combat from Intellect"] = "显示智力给的施法中法力恢复量"
-- /rb stat int mp5oc
--L["Show Normal Mana Regen"] = "显示5秒外回魔"
--L["Show Mana Regen while not in combat from Intellect"] = "显示在非施法状态下的法力恢复量"
-- /rb stat int rap
L["Show Ranged Attack Power"] = "显示远程攻击强度"
...
-- /rb stat spi mp5
--L["Show Combat Mana Regen"] = "显示施法回魔"
--L["Show Mana Regen while in combat from Spirit"] = "显示在施法状态时，精神给的法力恢复量"
-- /rb stat spi mp5oc
--L["Show Normal Mana Regen"] = "显示正常回魔"
--L["Show Mana Regen while not in combat from Spirit"] = "显示在未施法状态时，精神给的法力恢复量"
-- /rb stat spi hp5
...
-- /rb sum basic mp5
--L["Sum Combat Mana Regen"] = "统计法力恢复"
--L["Combat Mana Regen <- Mana Regen, Spirit"] = "法力恢复 ← 法力恢复、精神"
-- /rb sum basic mp5oc
--L["Sum Normal Mana Regen"] = "统计法力恢复(未施法时)"
--L["Normal Mana Regen <- Spirit"] = "法力恢复(未施法时) ← 精神"
-- /rb sum basic hp5
