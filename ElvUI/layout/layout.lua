...
function LO:Initialize()
	...
	if E.private.general.dtlowerpanel then self.CreateLowerDPPanel() end		
end
...
function LO:CreateLowerDPPanel()
	...
	lldppanel:Point("RIGHT", LowerCDPPanel, "LEFT", -2, 0)
	...
	lrdppanel:Point("LEFT", LowerCDPPanel, "RIGHT", 2, 0)
