...
=======
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если вам нужна техническая поддержка, посетите наш форум на www.tukui.org. Вы можете сообщать о багах и выдвигать предложения на http://wow.curseforge.com/addons/elvui/tickets ."
>>>>>>> origin/master
L["Loot"] = "Добыча"
...
L["Save your keybinds with your ElvUI profile. That way if you have the dual spec feature enabled in ElvUI you can swap keybinds with your specs."] = "Сохранять назначение клавишь в вашем профиле ElvUI. Таким образом при активации функции использования двойдого набора профилей для талантов в ElvUI вы можете менять назначения клавиш для разных специализаций."
L["says"] = "говорит"
L["Scale"] = "Масштаб"
...
L["The height of the bars while skada is embedded."] = "Высота полос Skada во встроенном состоянии" -- Needs review
