...
L["Display raid reminder bar on the minimap."] = "미니맵에 레이드 리마인더 바를 표시합니다."
...
L["Embedded Bar Height"] = "임베디드 바 높이" -- Needs review
L["Empty Slot"] = "빈 슬롯"
L["Enable"] = "사용"
...
L["Procs"] = "발동"
L["Profile Binds"] = "프로필 연결" -- Needs review
L["Profiles"] = "프로필"
L["Profit:"] = "이익:"
L["Purchase"] = "구매"
...
L["Right Click:"] = "오른쪽 클릭하십시오 :" -- Needs review
...
L["Save your keybinds with your ElvUI profile. That way if you have the dual spec feature enabled in ElvUI you can swap keybinds with your specs."] = "단축키는 ElvUI 듀얼 사양 기능을 시작한 경우, 단축키 세트를 전환하는 능력을 전환, ElvUI 프로파일에 설정을 저장합니다." -- Needs review
L["says"] = "일반"
L["Scale"] = "크기"
...
L["The height of the bars while skada is embedded."] = "막대의 높이는 skada가 내장되는 동안." -- Needs review
...
L["Toggle Bags"] = "가방 전환"
L["Toggle Chat Frame"] = "채팅 프레임 전환" -- Needs review
L["Toggle Embedded Addon"] = "임베디드 Addon을 전환" -- Needs review
...
L["You have reached the maximum amount of friends, remove 2 for this module to function properly."] = "친구 숫자가 최대에 도달했습니다. 이 모듈이 적절하게 작동하기 위해선 2개를 지워야 합니다."
...
L["You need to be at least level %d to whisper me."] = "당신은 저에게 귓속말을 하기 위해서 최소 %d 의 레벨이 필요합니다."
