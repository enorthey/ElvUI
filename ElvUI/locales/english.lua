...
L["Detected either the Routes or GatherMate2 addon running, if you wish to use these addons with ElvUI you must type the /farmmode command."] = "Detected either the Routes or GatherMate2 addon running, if you wish to use these addons with ElvUI you must type the /farmmode command."
...
L["Display raid reminder bar on the minimap."] = "Display raid reminder bar on the minimap."
...
L["Resolution Setup"] = "Resolution Setup"
...
L["You need to be at least level %d to whisper me."] = "You need to be at least level %d to whisper me."
...
L['Auto Custom Lag Tolerance based off of latency'] = true;
L["DataText Font"] = true;
L["The font that datatext will use."] = true;
L["Datatext Font Size"] = true;
L["Sets The Font size of Datatexts"] = true;
L["AURAS_DESC"] = "Setup the auras near the minimap.";
L['Auras'] = true;
L['Enable'] = true;
L['Enable Auras near minimap'] = true;
L['Size'] = true;
