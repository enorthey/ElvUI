...
=======
L["LOGIN_MSG"] = "Bienvenue sur %sElvUI|r version %s%s|r, tapez /ec afin d'accéder au menu de configuration en jeu. Si vous avez besoin d'un support technique, vous pouvez nous rejoindre sur http://www.tukui.org ou poster un ticket sur: http://wow.curseforge.com/addons/elvui/tickets."
>>>>>>> origin/master
L["Loot"] = "Butin"
...
=======
L["Your version of ElvUI is out of date. You can download the latest version from www.curse.com"] = "Une version plus récente d'ElvUi est disponible. Vous pouvez télécharger la dernière version sur www.curse.com"
>>>>>>> origin/master
