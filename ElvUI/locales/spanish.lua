...
L["Are you sure you want to delete all your gray items?"] = "¿Estás seguro que deseas eliminar todos tus objetos grises?"
...
L["Click the button below to resize your chat frames, unitframes, and reposition your actionbars."] = "Haz clic en el botón de abajo para cambiar el tamaño de los cuadros de chat y de unidad, y reubicar tus barras de acción."
...
L["Display raid reminder bar on the minimap."] = "Muestra el recoradatorio de banda en el minimapa." -- Needs review
-- L["Display Target"] = ""
L["Display the hyperlink tooltip while hovering over a hyperlink."] = "Muestra el tooltip del enlace cuando pasas el cursor sobre un enlace." -- Needs review
...
L["Enable"] = "Habilitar"
L["Enable/Disable the all-in-one bag."] = "Habilitar/Deshabilitar la bolsa todo en uno." -- Needs review
...
L["Grid Size:"] = "Tamaño de la Rejilla:" -- Needs review
...
L["middle"] = "Medio"
L["Minimap Size"] = "Tamaño del Minimapa" -- Needs review
L["Minutes"] = "Minutes"
...
L["Number of time in seconds to scroll down to the bottom of the chat window if you are not scrolled down completely."] = "Tiempo en segundos para desplazarse al final de la ventana de chat si no se ha desplazado completamente hasta el final." -- Needs review
...
L["One or more of the changes you have made will effect all characters using this addon. You will have to reload the user interface to see the changes you have made."] = "Uno o más cambios que hiciste afectarán todos los personajes que usen este addon. Tendrás que recargar la interfaz para ver los cambios."
...
L["Prevent the same messages from displaying in chat more than once within this set amount of seconds, set to zero to disable."] = "Previene que los mismos mensajes se muestren más de una vez en el chat dentro de un cierto número de segundos. Establécelo a cero para desactivar." -- Needs review
...
L["Raid Reminder"] = "Recordatorio de Banda" -- Needs review
L["Ranged"] = "A Distancia"
L["Rapidly update the health, uses more memory and cpu. Only recommended for healing."] = "Actualiza rápidamente la salud. Usa más memoria y CPU. Sólo se recomienda para sanación."
...
L["Resolution Setup"] = "Ajuste de Resolución"
...
L["says"] = "dice"
L["Scale"] = "Escala"
L["Scroll Interval"] = "Intervalo de Desplazamiento" -- Needs review
...
L["%s frame(s) has a conflicting anchor point, please change either the buff or debuff anchor point so they are not attached to each other. Forcing the debuffs to be attached to the main unitframe until fixed."] = "El(Los) cuadro(s) %s tiene(n) un punto de anclaje en conflicto. Por favor cambia el punto de anclaje de Beneficios o Perjuicios para que no estén anclados entre sí. Se forzará a los Perjuicios a anclarse al cuadro principal de unidad hasta que se corrija el problema."
...
L["Spaced"] = "Espaciado"
L["Spacing"] = "Espaciado"
L["Spam Interval"] = "Intervalo de Spam" -- Needs review
...
L["The font that the unitframes will use."] = "La fuente que los cuadros de unidad usarán."
...
L["You have reached the maximum amount of friends, remove 2 for this module to function properly."] = "Haz alcanzado la cantidad máxima de amigos. Elimina 2 para que este módulo funcione correctamente." -- Needs review
...
L["You need to be at least level %d to whisper me."] = "Necesitas tener como mínimo nivel %d para poder susurrarme."
...
<<<<<<< HEAD
L["Your version of ElvUI is out of date. You can download the latest version from www.tukui.org"] = "Tu versión de ElvUI no está actualizada. Puedes descargar la última versión de www.tukui.org"
=======
