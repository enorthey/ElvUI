...
local rollpairs = locale == "deDE" and {
    ...
    ["(.*)ë‹˜ì´ íšë“í•  ìˆ˜ ì—†ëŠ” ì•„ì´í…œì´ì–´ì„œ ìžë™ìœ¼ë¡œ ì£¼ì‚¬ìœ„ êµ´ë¦¬ê¸°ë¥¼ í¬ê¸°í–ˆìŠµë‹ˆë‹¤: (.+)"] = "pass",
    ["(.*)ë‹˜ì´ ì£¼ì‚¬ìœ„ êµ´ë¦¬ê¸°ë¥¼ í¬ê¸°í–ˆìŠµë‹ˆë‹¤: (.+)"] = "pass",
    ["(.*)ë‹˜ì´ ì°¨ë¹„ë¥¼ ì„ íƒí–ˆìŠµë‹ˆë‹¤: (.+)"] = "greed",
    ["(.*)ë‹˜ì´ ìž…ì°°ì„ ì„ íƒí–ˆìŠµë‹ˆë‹¤: (.+)"] = "need",
	["(.*)ë‹˜ì´ ë§ˆë ¥ ì¶”ì¶œì„ ì„ íƒí–ˆìŠµë‹ˆë‹¤: (.+)"] = "disenchant",		
