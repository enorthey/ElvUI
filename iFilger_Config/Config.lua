...
C["Filger_Panels"] = {
	["MAGE"] = {
		{ name = "iFilgerFocusBuffs", w = 200, h = 37, anchor = "TOPRIGHT", x = 440, y = 342, text = "Focus Buffs" },
		{ name = "iFilgerProcs", w = 200, h = 40, anchor = "TOPRIGHT", x = -220, y = -16, text = "Procs / Buffs" },
		{ name = "iFilgerBuffDebuff", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = -16, text = "Debuffs" },
		{ name = "iFilgerCooldowns", w = 160, h = 40, anchor = "TOPRIGHT", x = -220, y = -104, text = "Cooldowns" },
	},
	["DEATHKNIGHT"] = {
		{ name = "iFilgerProcs", w = 200, h = 40, anchor = "TOPRIGHT", x = -220, y = -16, text = "Procs / Buffs" },
		{ name = "iFilgerBuffDebuff", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = -16, text = "Debuffs" },
	...
	["PRIEST"] = {
		...
		{ name = "iFilgerBuffDebuff", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = -16, text = "Debuffs" },
		{ name = "iFilgerCooldowns", w = 160, h = 40, anchor = "TOPRIGHT", x = -220, y = -104, text = "Cooldowns" },
		{ name = "iFilgerBuffTargetHeal", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = -60, text = "Heal Buff Target" },
		{ name = "iFilgerBuffPlayerHeal", w = 200, h = 40, anchor = "TOPRIGHT", x = -220, y = -60, text = "Heal Buff Player" },
		{ name = "iFilgerFocusBuffs", w = 200, h = 37, anchor = "TOPRIGHT", x = 440, y = 342, text = "Focus Buffs" },
	},
	["WARLOCK"] = {
		{ name = "iFilgerFocusBuffs", w = 200, h = 37, anchor = "TOPRIGHT", x = 440, y = 342, text = "Focus Buffs" },
	...
	["ROGUE"] = {
		{ name = "iFilgerProcs", w = 200, h = 40, anchor = "TOPRIGHT", x = -220, y = -16, text = "Procs / Buffs" },
		{ name = "iFilgerBuffDebuff", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = -16, text = "Debuffs" },
		{ name = "iFilgerCooldowns", w = 200, h = 40, anchor = "TOPRIGHT", x = -220, y = -104, text = "Cooldowns" },
		{ name = "iFilgerFocusBuffs", w = 200, h = 37, anchor = "TOPRIGHT", x = 440, y = 342, text = "Focus Buffs" },
		{ name = "iFilgerRage", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = 110, text = "Rage Buffs" },
	},
	["PALADIN"] = {
		{ name = "iFilgerProcs", w = 200, h = 40, anchor = "TOPRIGHT", x = -220, y = -16, text = "Procs / Buffs" },
		{ name = "iFilgerBuffDebuff", w = 200, h = 40, anchor = "TOPLEFT", x = 220, y = -16, text = "Debuffs" },
	...
	["ALL"] = {
		--{ name = "iFilgerEnhancements", w = 200, h = 40, anchor = "BOTTOMRIGHT", x = 165, y = 248, text = "Enhancements" },
		{ name = "iFilgerPveDeBuffs", w = 250, h = 72, anchor = "TOPRIGHT", x = -220, y = 60, text = "Player Debuffs" },
		--{ name = "iFilgerPvpPlayerDebuffs", w = 250, h = 72, anchor = "TOPRIGHT", x = -220, y = 60, text = "Pvp Player Debuffs" },
		{ name = "iFilgerPvpTargetDebuffs", w = 250, h = 72, anchor = "TOPLEFT", x = 220, y = 60, text = "Target Debuffs" },
		{ name = "iFilgerTanksCDs", w = 200, h = 20, anchor = "CENTER", x = -600, y = 300, text = "Tanks CDs" },
		{ name = "iFilgerTanksCDsFocus", w = 200, h = 20, anchor = "CENTER", x = -600, y = 200, text = "Tanks focus CDs" },
	},
}
...
--			BarWidth = 150,
			Size = 40,
			setPoint = { "BOTTOMRIGHT", "iFilgerCooldowns", 0, 0 },
...
--			BarWidth = 150,
			Size = 40,
			setPoint = { "BOTTOMLEFT", "iFilgerBuffDebuff", 0, 0 },
...
--			BarWidth = 150,
			Size = 40,
			setPoint = { "BOTTOMRIGHT", "iFilgerProcs", 0, 0 },
...
--			BarWidth = 150,
			Size = 40,
			setPoint = { "TOPRIGHT", "iFilgerFocusBuffs", 0, 0 },
	...
	["PRIEST"] = { ---------------------------------------------------- Priest
		{
			...
			Alpha = 1,
			Size = 40,
			setPoint = { "BOTTOMRIGHT", "iFilgerBuffPlayerHeal", 0, 0 },
...
--			BarWidth = 150,
		...
		},	
		{
			...
			Alpha = 1,
			Size = 40,
			setPoint = { "BOTTOMLEFT", "iFilgerBuffTargetHeal", 0, 0 },
...
--			BarWidth = 150,
		...
		},
		{
			...
			Alpha = 1,
			Size = 40,
			setPoint = { "TOPRIGHT", "iFilgerFocusBuffs", "TOPRIGHT", 0, 0 },
	...
	["HUNTER/DRUID/ROGUE"] = {  ---------------------------------------------------- Hunt & Drood
		{
			...
			Alpha = 1,
			Size = 40,
			setPoint = { "BOTTOMLEFT", "iFilgerRage", 0, 0 },
...
--			BarWidth = 150,
			Size = 72,
			setPoint = {  "BOTTOMLEFT", "iFilgerPvpTargetDebuffs" ,0,0 },
...
--			BarWidth = 150,
			Size = 72,
			setPoint = {  "BOTTOMRIGHT", "iFilgerPveDeBuffs" ,0,0 },			
	...
	["PVE"] = {
		{
			Name = "PlayerDebuffs", -- list by jasje, taken from aurawatch.lua
			Enable = true,
			Direction = "LEFT",
			Interval = 4,
			Mode = "ICON",
