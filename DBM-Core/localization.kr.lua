...
DBM_CORE_OPTION_HEALTH_FRAME		= "보스 체력 프레임 보기"
...
DBM_PIZZA_SYNC_INFO					= "|Hplayer:%1$s|h[%1$s]|h님이 당신에게 DBM 바 보냄: '%2$s'\n|HDBM:cancel:%2$s:nil|h|cff3588ff[바 취소]|r|h  |HDBM:ignore:%2$s:%1$s|h|cff3588ff[%1$s 바 무시]|r|h"
...
DBM_CORE_RANGECHECK_SOUND_OPTION_2	= "지정 거리 이내 사람이 1명 이상 있을 경우 소리"
...
DBM_SPEED_KILL_TIMER_TEXT	= "가장 빨랐던 보스 전투"
DBM_SPEED_KILL_TIMER_OPTION	= "가장 빨랐던 보스 전투 시간을 바로 표시"
